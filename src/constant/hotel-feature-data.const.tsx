  ...
  Lunch: [
    {
      ...
      desc: "Sed id magna vitae eros sagittis euismod.",
      image: require("../assets/images/img-04.jpg"),
      currencyType: "INR",
      price: 10,
    },
    {
      ...
      desc: "Sed id magna vitae eros sagittis euismod.",
      image: require("../assets/images/img-05.jpg"),
      currencyType: "INR",
      price: 50,
    },
    {
      ...
      desc: "Sed id magna vitae eros sagittis euismod.",
      image: require("../assets/images/img-06.jpg"),
      currencyType: "INR",
      price: 60,
    },
  ],
  Dinner: [
    {
      ...
      desc: "Sed id magna vitae eros sagittis euismod.",
      image: require("../assets/images/img-07.jpg"),
      currencyType: "INR",
      price: 10,
    },
    {
      ...
      desc: "Sed id magna vitae eros sagittis euismod.",
      image: require("../assets/images/img-08.jpg"),
      currencyType: "INR",
      price: 50,
    },
    {
...
export const galleryContent: { image: string }[] = [
  {
    image: require("../assets/images/gallery-img-01.jpg"),
  },
  {
    image: require("../assets/images/gallery-img-02.jpg"),
  },
  {
    image: require("../assets/images/gallery-img-03.jpg"),
  },
  {
    image: require("../assets/images/gallery-img-04.jpg"),
  },
  {
    image: require("../assets/images/gallery-img-05.jpg"),
  },
];
...
export const customerReviewContent: CustomerReviewType[] = [
  ...
  {
    name: "Adarsh Dubey",
    image: require("../assets/images/profile-7.jpg"),
    designation: "Founder",
...
export const sliderContent: SlideItem[] = [
  {
    image: require("../assets/images/slider-01.jpg"),
  ...
  {
    image: require("../assets/images/slider-02.jpg"),
    title: "Welcome To Chhappanbhog Dhaba & Restaurant ",
    desc: ` See how your users experience your website in realtime or view
                trends to see any changes in performance over time.`,
  },
